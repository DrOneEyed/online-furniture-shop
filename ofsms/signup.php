...
<div class="container">
	 ...
	 <div class="registration">
		 <div class="registration_left">
			 <h2 style="color: #11C9DC;">new user? <span> create an account </span></h2>
			 ...
			 <!-- Form -->
				<form id="signup" name="signup" action="" method="post" onsubmit="return checkpass();">
					...
					<div>
						<input type="submit" value="create an account" id="" name="submit" style="background-color: #11C9DC; color: #000;">
					</div>
		 ...
		 <div class="registration_left">
			 <h2 style="color: #11C9DC;">existing user</h2>
			 <div class="registration_form">
			 <!-- Form -->
				<form id="registration_form" action="" name="login" method="post">
					...
					<div>
						<input type="submit" value="sign in" name="login" id="login" style="color: #000; background-color: #11C9DC;">
					</div>
					<div class="forget">
