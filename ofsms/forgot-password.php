...
<div class="login_sec">
	 <div class="container">
		 ...
		 <h2 style="color: #11C9DC;">Forgot Password</h2>
		 <div class="col-md-6 log">			 
				 ...
				 <form action="" method="post" name="chngpwd" onSubmit="return valid();">
					 ...
					 <input type="submit" value="Reset" name="submit" style="color: #000; background-color: #11C9DC;">
					  </form>				 
		 </div>
		  <div class="col-md-6 login-right">
			  	<h3 style="color: #11C9DC;">NEW REGISTRATION</h3>
				<p>By creating an account with our store, you will be able to move through the checkout process faster, store multiple shipping addresses, view and track your orders in your account and more.</p>
				<a class="acount-btn" href="signup.php" style="color: #000; background-color: #11C9DC;">Create an Account</a>
		 </div>
